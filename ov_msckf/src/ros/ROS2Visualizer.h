...
protected:
  ...
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr pub_num_points_slam, pub_num_points_msckf;
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr pub_status_num_points_slam;
  ...
  std::string node_namespace = "uav1";
};
